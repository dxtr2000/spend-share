...
<template>
  <header class="dashboard-header sticky top-0 z-30 mb-5 w-full min-w-0 border-b border-border bg-background/85 backdrop-blur-lg">
    <div class="dashboard-header-inner flex min-w-0 items-center gap-2 py-3.5 sm:gap-3">
